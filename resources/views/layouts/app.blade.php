...
<head>
    ...
    <meta name="description" content="PT. Wahyu Mustika Engineering adalah sebuah perusahaan Engineering, Contracting & Supplier. Kami menawarkan jasa engineering, procurement, contructing & maintenance dalam bidang electrical dan automation dalam proses pembangunan industry juga pembangunan gedung komersial.">
    <meta name="keywords" content="Mechanical Services, Electrical Services, Manufacture Services, Marine Services, Intrumentation, Automation Services, Wahyu Mustika Engineering">
    <meta name="author" content="Wahyu Mustika Engineering" />
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link fw-bold dropdown-toggle text-dark animate__animated animate__fadeInLeft animate__delay-3s" href="{{url('/')}}/#aboutme" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-bold text-dark animate__animated animate__fadeInLeft animate__delay-3s" href="{{url('/')}}/#Services">@lang('company.navbar.service')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-bold text-dark animate__animated animate__fadeInLeft animate__delay-3s" href="{{url('/')}}/#News">@lang('company.navbar.news')</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="p-2">
                    <a href="lang/en" class="navbar-text p-1 animate__animated animate__fadeInDown animate__delay-4s"><img src="{{asset('/public/images/icon/united-kingdom-box.png')}}" alt="" srcset="" class="img-fluid" style="max-width:25px;"></a>                 
                    <a href="lang/id" class="navbar-text p-1 animate__animated animate__fadeInDown animate__delay-4s"><img src="{{asset('/public/images/icon/indonesia.png')}}" alt="" srcset="" class="img-fluid" style="max-width:30px;"></a>
                </div>
            </div>            
        </div>
    </nav>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <ul class="nav flex-column">
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">@lang('company.navbar.about')</a></li>
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">@lang('company.aboutdown.kebijakan')</a></li>
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">@lang('company.aboutdown.struktur')</a></li>
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">@lang('company.aboutdown.sertifikat')</a></li>
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">@lang('company.navbar.service')</a></li>
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">@lang('company.navbar.news')</a></li>
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">@lang('company.navbar.contact')</a></li>
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">@lang('company.navbar.carier')</a></li>
                            </ul>
                        </div>
                        <div class="col-6">
                            <h5>Product & Services</h5>
                            <ul class="nav flex-column">
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Mechanical</a></li>
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Electrical</a></li>
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Manufacture Industri</a></li>
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Marine</a></li>                                
                                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Instrument & Automatin</a></li>                                
                            </ul> 
                        </div>
                    </div>
                    <div class="row">
